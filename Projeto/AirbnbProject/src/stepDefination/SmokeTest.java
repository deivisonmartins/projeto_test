...
public class SmokeTest {
	...
	public void i_must_do_to_search_for_places_in_Manaus() throws Throwable {
		...
		WebElement clickInput = (new WebDriverWait(driver, temp_static)).until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@id='site-content']/div[1]/div[2]/div/div/div/div/div[2]/div/div/div/div/form/div[1]/div/div/div/div/div/div")));
		clickInput.click();
		
		WebElement inputDados = (new WebDriverWait(driver, temp_static)).until(ExpectedConditions.presenceOfElementLocated(By.xpath("//input[contains(@role,'textbox')]")));
		inputDados.sendKeys("Manaus");
		
		//search button
		WebElement button = (new WebDriverWait(driver, temp_static)).until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@id='site-content']/div[1]/div[2]/div/div/div/div/div[2]/div/div/div/div/form/div[2]/button")));
		button.click();
	}
	...
	public void i_have_to_filter_by_date() throws Throwable {
		...
		WebElement buttonInput = (new WebDriverWait(driver, temp_static)).until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@id='menuItemComponent-date_picker']/div/div")));
		buttonInput.click();
		
		WebElement buttonInputDate = (new WebDriverWait(driver, temp_static)).until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@id='menuItemComponent-date_picker']/div/div/div[1]/div/div/div/div/div/div/div[2]/div[2]/div/div[3]/div")));
		buttonInputDate.click();
				
		//go to the specific month, January
		for (int i = 1; i == 10; i++) {																									 
			
			WebElement buttonDate = (new WebDriverWait(driver, temp_static)).until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//*[@id='menuItemComponent-date_picker']/div/div/div[1]/div/div/div/div/div/div/div[2]/div[1]/button[2]")));
			buttonDate.click();
		}
